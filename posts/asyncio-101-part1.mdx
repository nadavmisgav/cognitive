...
אם ההבנה החדשה של תכנות אסינכרוני ואיך אפשר לממש אותו, נרצה דרך קלה יותר שלא
...
זהה
לגנרטורים!
בפועל אם אנחנו יודעים לכתוב קוד שמנצל גנרטורים, אנחנו יודעים כעת לכתוב קוד אסינכרוני. אנחנו יכולים לתת לספריה להריץ אותו ואת זה קחו כהצצה להמשך.
