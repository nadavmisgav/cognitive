...
ternary if.
כלומר אם התנאי מתקיים אז השגיאה שאצפה לה תיהיה 
`SomeException`
...
הInterpeter
של פייתון מריץ.
למה זה חשוב לזכור את זה, כי מה שאני מחפש זה לא איזור קוד שבו אוכל להכניס לוגיקה של תנאי ואם התנאי מתקיים לקרוא 
ל`except`
